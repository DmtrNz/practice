const zeroFuel = (distanceToPump, mpg, fuelLeft) => {
  ...
  zeroFuel(50, 25, 2); /*You were camping with your friends far away from home, 
  ...
  possible to get to the pump or not. Function should return true if it is possible and false if not.*/