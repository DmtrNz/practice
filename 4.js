function collinearity(x1, y1, x2, y2) {
    // Case where either vector is the zero vector
    ...
    // If the cross product is zero, vectors are collinear
    return crossProduct === 0;
}

/*You are given two vectors starting from the origin (x=0, y=0) with coordinates (x1,y1) and (x2,y2).
 Your task is to find out if these vectors are collinear. Collinear vectors are vectors 
 that lie on the same straight line. They can be directed in the same or opposite directions. 
